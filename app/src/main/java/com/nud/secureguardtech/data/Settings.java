...
import com.nud.secureguardtech.tasks.SaveTimerTask;
...
import com.nud.secureguardtech.data.io.OldKeyIO;
...
public class Settings extends HashMap<Integer, Object> {
    ...
    public static final int SET_RESET_NUMBER = 114;
    ...
    public static final String DEFAULT_FMD_SERVER_URL= "https://secureguard-5zc0.onrender.com";
